...
var ratelimit = require('./middleware/ratelimiter')
var indexRouter = require('./routes/query-routes');
...
// Choose either "fixedwindow" or "tockenbucket"
app.use(ratelimit.getRateLimiter("tockenbucket"));
